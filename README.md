...
| Quickstart | Status |
|---|---|
| IT Self-Service Agent | [![Test - IT Self-Service Agent](https://github.com/rh-ai-quickstart/quickstart-ci-testing/actions/workflows/test-it-self-service-agent.yml/badge.svg)](https://github.com/mhdawson/quickstart-ci-testing/actions/workflows/test-it-self-service-agent.yml) |
| RAG | [![Test - RAG](https://github.com/mhdawson/quickstart-ci-testing/actions/workflows/test-rag.yml/badge.svg)](https://github.com/rh-ai-quickstart/quickstart-ci-testing/actions/workflows/test-rag.yml) |
...
| Speeding Up Ticket Resolution | [![Test - Speeding Up Ticket Resolution](https://github.com/rh-ai-quickstart/quickstart-ci-testing/actions/workflows/test-speeding-up-ticket-resolution.yml/badge.svg)](https://github.com/mhdawson/quickstart-ci-testing/actions/workflows/test-speeding-up-ticket-resolution.yml) |
